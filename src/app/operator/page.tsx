      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <form onSubmit={onSearch} className="rounded-xl border border-gray-200 dark:border-slate-800 bg-gray-50 dark:bg-slate-900 p-6">
          <div className="flex gap-3">
            <input
              className="flex-1 rounded-lg border border-gray-300 dark:border-slate-700 bg-gray-100 dark:bg-slate-800 p-2 text-right text-slate-900 dark:text-white placeholder-gray-400 dark:placeholder-slate-500"
        ...
        <div className="rounded-xl border border-gray-200 dark:border-slate-800 bg-gray-50 dark:bg-slate-900 p-6">
          ...
          {loading ? (
            ...
            <p className="py-8 text-center text-slate-400 dark:text-slate-500">تاکنون موردی ثبت نشده است</p>
          ) : (
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-slate-800">
                  {registrations.map((r) => (
                    <tr key={r.id} className="hover:bg-gray-100/50 dark:hover:bg-slate-900/50">
                      ...
                      <td className="px-3 py-2 font-mono text-slate-500 dark:text-slate-400" dir="ltr">{r.nationalId}</td>
